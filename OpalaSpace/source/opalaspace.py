...
musica_fundo = pygame.mixer.music.load('/home/arbarros/dev/OpalaSpace/sons/sons_Star Wars - The Imperial March.mp3')

pygame.mixer.music.play(-1)

barulho_disparo_torpedo = pygame.mixer.Sound('/home/arbarros/dev/OpalaSpace/sons/star-wars-blaster.mp3')
barulho_disparo_torpedo.set_volume(0.1)

barulho_colisao_torpedo = pygame.mixer.Sound('/home/arbarros/dev/OpalaSpace/sons/sons_smw_thunder.wav')
barulho_colisao_torpedo.set_volume(2)

barulho_colisao_alien = pygame.mixer.Sound('/home/arbarros/dev/OpalaSpace/sons/blaster.mp3')
...
img_fundo = pygame.image.load('/home/arbarros/dev/OpalaSpace/figs/fundo5.jpg').convert_alpha()
img_fundo = pygame.transform.scale(img_fundo, (largura,altura))

img_alien = pygame.image.load('/home/arbarros/dev/OpalaSpace/figs/MilleniumFalcon.png').convert_alpha()
img_alien = pygame.transform.scale(img_alien, (200,200))
img_alien = pygame.transform.rotate(img_alien, +90)


#img da explosao
img_explosion = pygame.image.load('/home/arbarros/dev/OpalaSpace/figs/explosion.png').convert_alpha()
img_explosion = pygame.transform.scale(img_explosion, (210, 210))



img_aviao = pygame.image.load('/home/arbarros/dev/OpalaSpace/figs/Nave.png').convert_alpha()
img_aviao = pygame.transform.scale(img_aviao, (150,150))
img_aviao = pygame.transform.rotate(img_aviao, -90)

img_missil = pygame.image.load('/home/arbarros/dev/OpalaSpace/figs/torpedo.png')
...
pontuacao = pygame.font.SysFont('/home/arbarros/dev/OpalaSpace/fonts/PixelGameFont.tff', 50)
total_vidas = pygame.font.SysFont('/home/arbarros/dev/OpalaSpace/fonts/PixelGameFont.tff', 50)
...
while executar == True:
    ...
    if vidas == 0:
        ...
        img_aviao = pygame.image.load('/home/arbarros/dev/OpalaSpace/figs/explosion.png').convert_alpha()
